...
public class Starter {
	...
	public Starter(String[] args) throws IOException {
		...
		startBtn.setBounds(800, 800, 90, 30);
		frame.add(startBtn);
		...
		commandLine.setFont(new Font("Arial", 1, 11));
		frame.add(commandLine);
		
		
		executeCmd = new JButton();
		executeCmd.setToolTipText("Executes the command in the command line");
